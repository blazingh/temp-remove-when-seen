  ...
  return (
    <div className="w-full h-[140px]  overflow-hidden flex">
      ...
      <div className="relative w-[96px] h-full border rounded-md">
        {(item.image && <Image
          src={imageUrlHelper(item.image.src, { w: 96 * 2, h: 140 * 2, q: 75, fallBackImage: 'https://distedavim-user-uploaded-images.s3.amazonaws.com/treatment/Ekran+Resmi+2024-02-22+17.59.53.png' })}
          alt={'deneme'}
          fill
